...
cmd({ 
    ...
    try { 
        ...
        let apiUrl = `https://api.giftedtech.web.id/api/download/ytmp4?apikey=gifted&url=https%3A%2F%2Fyoutu.be%2FwdJrTQJh1ZQ%3Ffeature%3Dshared${encodeURIComponent(yts.url)}`;
